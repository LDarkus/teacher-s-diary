    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-7 d-flex justify-content-end align-items-end">
                <a class="btn btn-primary " href="{{ route('disciplines.index') }}">Вернуться к
                    списку дисциплин</a>
            </div>
        </div>
        <div class="row mt-4">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <form class="me-3" class="text-center" method="GET"
                                            ...
                                            @method('GET')
                                            <input type="submit" class="btn btn-primary " value="Оценить группу">
                                        </form>
                                        <form class="me-3" class="text-center" method="GET"
                                            action="{{ route('disciplines.showStudentAttendances', [$discipline, 'group' => $group]) }}">
                                            @method('GET')
                                            <input type="submit" class="btn btn-warning " value="Отметить посещаемости">
                                        </form>
